...
if (isset($_SESSION['status'])) {
    ...
    if (isset($_POST['name'])) {
        ...
        $query = "SELECT * FROM pharaohs WHERE name LIKE '%$search_name%'";
...
<div class="container mx-auto mt-1 p-1">
    ...
    if (isset($result) && mysqli_num_rows($result) > 0) {
        while ($pharaoh = mysqli_fetch_assoc($result)) {
            ...
            ?>
            <div class="container mx-auto mt-10 p-4 flex items-center">
                <div class="max-w-screen-lg mx-auto bg-white shadow-md rounded-lg p-6">
                    <div class="flex">
                        <div class="mr-6">
                            <img src="../asset/uploads/<?php echo $pharaoh['pic']; ?>"
                                 alt="<?php echo $pharaoh['name']; ?>"
                                 class="w-full max-w-md max-h-64 h-auto rounded-lg">
                        </div>
                        <div>
                    ...
                    <div class="mb-4">
                        ...
                        <p><?php echo $pharaoh['description']; ?></p>
                    </div>

                    <div class="mb-4">
                        <!-- Comment Button -->
                        <button class="text-blue-600 underline cursor-pointer"
                                onclick="toggleComment(<?php echo $pharaoh['id']; ?>)">Comment
                        </button>
                        ...
                        <form method="post" enctype="multipart/form-data" action="../controller/addCommentCheck.php">
                            ...
                            <div id="commentBox_<?php echo $pharaoh['id']; ?>" class="hidden mt-2">
                                <textarea class="w-full h-20 px-3 py-2 border rounded focus:outline-none focus:shadow-outline"
        ...
        echo "No Records Found for the searched name: " . $_POST['name'];
    }
    ?>
</div>
</body>
